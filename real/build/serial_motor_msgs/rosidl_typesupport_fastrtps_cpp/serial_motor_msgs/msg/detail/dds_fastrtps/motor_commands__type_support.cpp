...
#include "serial_motor_msgs/msg/detail/motor_commands__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const serial_motor_msgs::msg::MotorCommands & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  serial_motor_msgs::msg::MotorCommands & ros_message)
{
  // Member: is_pwm
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = serial_motor_msgs::msg::MotorCommands;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const serial_motor_msgs::msg::MotorCommands *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<serial_motor_msgs::msg::MotorCommands *>(
    untyped_ros_message);
...
{
  return &serial_motor_msgs::msg::typesupport_fastrtps_cpp::_MotorCommands__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, serial_motor_msgs, msg, MotorCommands)() {
  return &serial_motor_msgs::msg::typesupport_fastrtps_cpp::_MotorCommands__handle;
}
