...
#ifndef SERIAL_MOTOR_MSGS__MSG__DETAIL__MOTOR_COMMANDS__TRAITS_HPP_
#define SERIAL_MOTOR_MSGS__MSG__DETAIL__MOTOR_COMMANDS__TRAITS_HPP_
...
inline void to_yaml(
  const serial_motor_msgs::msg::MotorCommands & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const serial_motor_msgs::msg::MotorCommands & msg)
{
  return serial_motor_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<serial_motor_msgs::msg::MotorCommands>()
{
  return "serial_motor_msgs::msg::MotorCommands";
}

template<>
inline const char * name<serial_motor_msgs::msg::MotorCommands>()
{
  return "serial_motor_msgs/msg/MotorCommands";
}

template<>
struct has_fixed_size<serial_motor_msgs::msg::MotorCommands>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<serial_motor_msgs::msg::MotorCommands>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<serial_motor_msgs::msg::MotorCommands>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // SERIAL_MOTOR_MSGS__MSG__DETAIL__MOTOR_COMMANDS__TRAITS_HPP_
