...
#include "serial_motor_msgs/msg/detail/motor_commands__rosidl_typesupport_fastrtps_c.h"
...
using _MotorCommands__ros_msg_type = serial_motor_msgs__msg__MotorCommands;
...
size_t get_serialized_size_serial_motor_msgs__msg__MotorCommands(
  const void * untyped_ros_message,
...
static uint32_t _MotorCommands__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_serial_motor_msgs__msg__MotorCommands(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_serial_motor_msgs
size_t max_serialized_size_serial_motor_msgs__msg__MotorCommands(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = serial_motor_msgs__msg__MotorCommands;
    is_plain =
      (
...
static size_t _MotorCommands__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_serial_motor_msgs__msg__MotorCommands(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, serial_motor_msgs, msg, MotorCommands)() {
